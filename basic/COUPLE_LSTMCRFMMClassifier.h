...
class COUPLE_LSTMCRFMMClassifier {
public:
  COUPLE_LSTMCRFMMClassifier() {
    _dropOut = 0.5;
  }
  ~COUPLE_LSTMCRFMMClassifier() {
...
public:
  ...
  UniLayer<xpu> _c1_olayer_linear;
  UniLayer<xpu> _c2_olayer_linear;
  ...
  MMCRFLoss<xpu> _c1_crf_layer;
  MMCRFLoss<xpu> _c2_crf_layer;
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, int wordcontext,
    const NRMat<dtype>& charEmb, int charcontext,
    const NRVec<NRMat<dtype> >& tagEmbs,
    int c1_labelSize, int c2_labelSize,int charhiddensize,
    ...
    _c1_labelSize = c1_labelSize;
    _c2_labelSize = c2_labelSize;
    ...
    _c1_olayer_linear.initial(_c1_labelSize, _hiddensize, false, 60, 2);

    _c1_crf_layer.initial(_c1_labelSize, 70);

    _c2_olayer_linear.initial(_c2_labelSize, _hiddensize, false, 60, 2);

    _c2_crf_layer.initial(_c2_labelSize, 70);
  ...
  inline void release() {
    ...
    _c1_olayer_linear.release();
    _c2_olayer_linear.release();
    ...
    _c1_crf_layer.release();
    _c2_crf_layer.release();

  }

  inline dtype process(const vector<Example>& examples, int iter, int corpus_type) {
    _eval.reset();
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      int _labelSize=(1==corpus_type?_c1_labelSize:_c2_labelSize);
      UniLayer<xpu>& _olayer_linear=(1==corpus_type?_c1_olayer_linear:_c2_olayer_linear);
      MMCRFLoss<xpu>& _crf_layer=(1==corpus_type?_c1_crf_layer:_c2_crf_layer);
  ...
  void predict(const vector<Feature>& features, vector<int>& results, int corpus_type) {
    int _labelSize=(1==corpus_type?_c1_labelSize:_c2_labelSize);
    UniLayer<xpu>& _olayer_linear=(1==corpus_type?_c1_olayer_linear:_c2_olayer_linear);
    MMCRFLoss<xpu>& _crf_layer=(1==corpus_type?_c1_crf_layer:_c2_crf_layer);
  ...
  dtype computeScore(const Example& example, const int corpus_type) {
    int _labelSize=(1==corpus_type?_c1_labelSize:_c2_labelSize);
    UniLayer<xpu>& _olayer_linear=(1==corpus_type?_c1_olayer_linear:_c2_olayer_linear);
    MMCRFLoss<xpu>& _crf_layer=(1==corpus_type?_c1_crf_layer:_c2_crf_layer);
  ...
  void updateParams(dtype nnRegular, dtype adaAlpha, dtype adaEps, int corpus_type) {
    UniLayer<xpu>& _olayer_linear=(1==corpus_type?_c1_olayer_linear:_c2_olayer_linear);
    MMCRFLoss<xpu>& _crf_layer=(1==corpus_type?_c1_crf_layer:_c2_crf_layer);
  ...
  void writeModel(LStream &outf) {
    ...
    WriteBinary(outf, _c1_labelSize);
    WriteBinary(outf, _c2_labelSize);
    ...
    _c1_crf_layer.writeModel(outf);
    _c2_crf_layer.writeModel(outf);

    _c1_olayer_linear.writeModel(outf);
    _c2_olayer_linear.writeModel(outf);
  ...
  void loadModel(LStream &inf) {
    ...
    ReadBinary(inf, _c1_labelSize);
    ReadBinary(inf, _c2_labelSize);
    ...
    // cout << "dtype " << _dropOut <<endl;
    _c1_crf_layer.loadModel(inf);
    _c2_crf_layer.loadModel(inf);

    _c1_olayer_linear.loadModel(inf);
    _c2_olayer_linear.loadModel(inf);
  ...
  void checkgrad(const vector<Example>& examples, Tensor<xpu, 2, dtype> Wd, Tensor<xpu, 2, dtype> gradWd, const string& mark, int iter, const int corpus_type) {
    ...
    for (int i = 0; i < examples.size(); i++) {
      ...
      lossAdd += computeScore(oneExam, corpus_type);
    }
    ...
    for (int i = 0; i < examples.size(); i++) {
      Example oneExam = examples[i];
      lossPlus += computeScore(oneExam, corpus_type);
    }
  ...
  void checkgrads(const vector<Example>& examples, int iter, const int corpus_type) {
    UniLayer<xpu>& _olayer_linear=(1==corpus_type?_c1_olayer_linear:_c2_olayer_linear);
    MMCRFLoss<xpu>& _crf_layer=(1==corpus_type?_c1_crf_layer:_c2_crf_layer);

    checkgrad(examples, _olayer_linear._W, _olayer_linear._gradW, "_olayer_linear._W", iter, iter, corpus_type);
    checkgrad(examples, _tanh_project._W, _tanh_project._gradW, "_tanh_project._W", iter, iter, corpus_type);

    checkgrad(examples, _tanhchar_project._W, _tanhchar_project._gradW, "_tanhchar_project._W", iter, corpus_type);
    checkgrad(examples, _tanhchar_project._b, _tanhchar_project._gradb, "_tanhchar_project._b", iter, corpus_type);

    checkgrad(examples, _gatedchar_pooling._bi_gates._WL, _gatedchar_pooling._bi_gates._gradWL, "_gatedchar_pooling._bi_gates._WL", iter, corpus_type);
    checkgrad(examples, _gatedchar_pooling._bi_gates._WR, _gatedchar_pooling._bi_gates._gradWR, "_gatedchar_pooling._bi_gates._WR", iter, corpus_type);
    checkgrad(examples, _gatedchar_pooling._bi_gates._b, _gatedchar_pooling._bi_gates._gradb, "_gatedchar_pooling._bi_gates._b", iter, corpus_type);

    checkgrad(examples, _gatedchar_pooling._uni_gates._W, _gatedchar_pooling._uni_gates._gradW, "_gatedchar_pooling._uni_gates._W", iter, corpus_type);
    checkgrad(examples, _gatedchar_pooling._uni_gates._b, _gatedchar_pooling._uni_gates._gradb, "_gatedchar_pooling._uni_gates._b", iter, corpus_type);

    checkgrad(examples, rnn_left_project._lstm_output._W1, rnn_left_project._lstm_output._gradW1, "rnn_left_project._lstm_output._W1", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_output._W2, rnn_left_project._lstm_output._gradW2, "rnn_left_project._lstm_output._W2", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_output._W3, rnn_left_project._lstm_output._gradW3, "rnn_left_project._lstm_output._W3", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_output._b, rnn_left_project._lstm_output._gradb, "rnn_left_project._lstm_output._b", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_input._W1, rnn_left_project._lstm_input._gradW1, "rnn_left_project._lstm_input._W1", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_input._W2, rnn_left_project._lstm_input._gradW2, "rnn_left_project._lstm_input._W2", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_input._W3, rnn_left_project._lstm_input._gradW3, "rnn_left_project._lstm_input._W3", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_input._b, rnn_left_project._lstm_input._gradb, "rnn_left_project._lstm_input._b", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_forget._W1, rnn_left_project._lstm_forget._gradW1, "rnn_left_project._lstm_forget._W1", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_forget._W2, rnn_left_project._lstm_forget._gradW2, "rnn_left_project._lstm_forget._W2", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_forget._W3, rnn_left_project._lstm_forget._gradW3, "rnn_left_project._lstm_forget._W3", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_forget._b, rnn_left_project._lstm_forget._gradb, "rnn_left_project._lstm_forget._b", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_cell._WL, rnn_left_project._lstm_cell._gradWL, "rnn_left_project._lstm_cell._WL", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_cell._WR, rnn_left_project._lstm_cell._gradWR, "rnn_left_project._lstm_cell._WR", iter, corpus_type);
    checkgrad(examples, rnn_left_project._lstm_cell._b, rnn_left_project._lstm_cell._gradb, "rnn_left_project._lstm_cell._b", iter, corpus_type);


    checkgrad(examples, rnn_right_project._lstm_output._W1, rnn_right_project._lstm_output._gradW1, "rnn_right_project._lstm_output._W1", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_output._W2, rnn_right_project._lstm_output._gradW2, "rnn_right_project._lstm_output._W2", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_output._W3, rnn_right_project._lstm_output._gradW3, "rnn_right_project._lstm_output._W3", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_output._b, rnn_right_project._lstm_output._gradb, "rnn_right_project._lstm_output._b", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_input._W1, rnn_right_project._lstm_input._gradW1, "rnn_right_project._lstm_input._W1", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_input._W2, rnn_right_project._lstm_input._gradW2, "rnn_right_project._lstm_input._W2", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_input._W3, rnn_right_project._lstm_input._gradW3, "rnn_right_project._lstm_input._W3", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_input._b, rnn_right_project._lstm_input._gradb, "rnn_right_project._lstm_input._b", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_forget._W1, rnn_right_project._lstm_forget._gradW1, "rnn_right_project._lstm_forget._W1", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_forget._W2, rnn_right_project._lstm_forget._gradW2, "rnn_right_project._lstm_forget._W2", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_forget._W3, rnn_right_project._lstm_forget._gradW3, "rnn_right_project._lstm_forget._W3", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_forget._b, rnn_right_project._lstm_forget._gradb, "rnn_right_project._lstm_forget._b", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_cell._WL, rnn_right_project._lstm_cell._gradWL, "rnn_right_project._lstm_cell._WL", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_cell._WR, rnn_right_project._lstm_cell._gradWR, "rnn_right_project._lstm_cell._WR", iter, corpus_type);
    checkgrad(examples, rnn_right_project._lstm_cell._b, rnn_right_project._lstm_cell._gradb, "rnn_right_project._lstm_cell._b", iter, corpus_type);

    checkgrad(examples, _crf_layer._tagBigram, _crf_layer._grad_tagBigram, "_crf_layer._tagBigram", iter, corpus_type);
